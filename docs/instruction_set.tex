...
\def\pinmodein#1 {\Verb|#10a0| - set I/O pin \Verb|N| to input mode}
\def\pinmodeout#1{\Verb|#10a1| - set I/O pin \Verb|N| to output mode}
\def\setpinlow#1    {\Verb|#10a2| - set I/O pin \Verb|N| to low}
\def\setpinhigh#1   {\Verb|#10a3| - set I/O pin \Verb|N| to high}
\def\pintodata#1 {\Verb|#10a4| - output I/O pin \Verb|N| to data bus}
\def\datatopin#1 {\Verb|#10a5| - write data bus to I/O pin \Verb|N|}
