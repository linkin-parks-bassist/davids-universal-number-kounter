...
const dunk_instr dunk_instrs[N_INSTR] = {
	...
	//**ALU**//
	UNARY___INSTR("inc",	0x3d, REGISTER, FIRST_NIBBLE | SECOND_NIBBLE),
	UNARY___INSTR("dec",	0x3e, REGISTER, FIRST_NIBBLE | SECOND_NIBBLE),
	UNARY___INSTR("not",	0x3f, REGISTER, FIRST_NIBBLE | SECOND_NIBBLE),
	UNARY___INSTR("lshift",	0x40, REGISTER, FIRST_NIBBLE | SECOND_NIBBLE),
	UNARY___INSTR("rshift",	0x41, REGISTER, FIRST_NIBBLE | SECOND_NIBBLE),
	
	BINARY__INSTR("inc",	0x42, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("dec",	0x43, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("not",	0x44, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("lshift",	0x45, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("rshift",	0x46, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	
	BINARY__INSTR("add",	0x47, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("sub",	0x48, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),	
	BINARY__INSTR("mul",	0x49, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("div",	0x4a, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("rem",	0x4b, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("ucmp",	0x4c, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("cmp",	0x4d, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("and",	0x4e, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("or",		0x4f, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("xor",	0x50, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	BINARY__INSTR("shift",	0x51, REGISTER, FIRST_NIBBLE, CONSTANT, FOLLOWING(1)),
	
	TERNARY_INSTR("add",	0x52, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, CONSTANT, FOLLOWING(1)),
	TERNARY_INSTR("sub",	0x53, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, CONSTANT, FOLLOWING(1)),	
	TERNARY_INSTR("mul",	0x54, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, CONSTANT, FOLLOWING(1)),
	TERNARY_INSTR("div",	0x55, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, CONSTANT, FOLLOWING(1)),
	TERNARY_INSTR("rem",	0x56, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, CONSTANT, FOLLOWING(1)),
	...
	BINARY__INSTR("div",	0x60, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("rem",	0x61, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("ucmp",	0x62, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("cmp",	0x63, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("and",	0x64, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("or",		0x65, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("xor",	0x66, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("shift",	0x67, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	
	TERNARY_INSTR("add",	0x68, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("sub",	0x69, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),	
	TERNARY_INSTR("mul",	0x6a, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("div",	0x6b, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("rem",	0x6c, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("ucmp",	0x6d, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("cmp",	0x6e, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("and",	0x6f, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("or",		0x70, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("xor",	0x71, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),
	TERNARY_INSTR("shift",	0x72, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE, REGISTER, FOLLOWING(1)),

	//**stack stuff**//

	// pushes
	NULLARY_INSTR("push",	0x73),
	UNARY___INSTR("push",	0x74, CONSTANT, FOLLOWING(1)),
	UNARY___INSTR("push",	0x75, CONSTANT | POINTER, OFFSET_FOLLOWING(1)),
	UNARY___INSTR("push",	0x76, REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("push",	0x77, REGISTER | POINTER, FIRST_NIBBLE | OFFSET_FOLLOWING(1)),
	UNARY___INSTR("push",	0x78, S_REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("push",	0x79, S_REGISTER | POINTER, FIRST_NIBBLE | OFFSET_FOLLOWING(1)),

	// pops
	NULLARY_INSTR("pop",	0x7a),
	UNARY___INSTR("pop",	0x7b, CONSTANT | POINTER, FOLLOWING(1)),
	UNARY___INSTR("pop",	0x7c, REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("pop",	0x7d, REGISTER | POINTER, FIRST_NIBBLE | OFFSET_FOLLOWING(1)),
	UNARY___INSTR("pop",	0x7e, S_REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("pop",	0x7f, S_REGISTER | POINTER, FIRST_NIBBLE | OFFSET_FOLLOWING(1)),
	
	// function stuff
	UNARY___INSTR("call",		0x80, CONSTANT, FOLLOWING(1)),
	UNARY___INSTR("fastcall",	0x81, CONSTANT, FOLLOWING(1)),
	
	NULLARY_INSTR("return",		0x82),
	
	// I/O pins
	UNARY___INSTR("pinmode_input",	0x83, CONSTANT, FIRST_NIBBLE),
	UNARY___INSTR("pinmode_output",	0x84, CONSTANT, FIRST_NIBBLE),
	
	UNARY___INSTR("pinmode_input",	0x85, REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("pinmode_output",	0x86, REGISTER, FIRST_NIBBLE),
	
	UNARY___INSTR("set_pin_low",	0x87, CONSTANT, FIRST_NIBBLE),
	UNARY___INSTR("set_pin_high",	0x88, CONSTANT, FIRST_NIBBLE),
	
	UNARY___INSTR("set_pin_low",	0x89, REGISTER, FIRST_NIBBLE),
	UNARY___INSTR("set_pin_high",	0x8a, REGISTER, FIRST_NIBBLE),
	
	BINARY__INSTR("read_pin",		0x8b, CONSTANT, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("write_pin",		0x8c, CONSTANT, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	
	BINARY__INSTR("read_pin",		0x8d, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	BINARY__INSTR("write_pin",		0x8e, REGISTER, FIRST_NIBBLE, REGISTER, SECOND_NIBBLE),
	
	BINARY__INSTR("prints",			0x8f, CONSTANT, FOLLOWING(1), CONSTANT, FOLLOWING(2)),
	BINARY__INSTR("prints",			0x90, REGISTER | POINTER, FIRST_NIBBLE | OFFSET_FOLLOWING(2), CONSTANT, FOLLOWING(1)),
